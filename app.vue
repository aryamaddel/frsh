...
<template>
  <div
    id="app"
    class="min-h-screen flex flex-col bg-gradient-to-br from-gray-50 to-gray-100 text-gray-800 antialiased"
  >
    <header
      class="bg-white shadow-md sticky top-0 z-50 backdrop-blur-sm bg-white/90"
    >
      <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div class="flex justify-between items-center">
          <NuxtLink
            to="/"
            class="text-2xl sm:text-3xl font-extrabold text-green-500 hover:text-green-600 transition-colors duration-200 tracking-tight"
          >
            frsh
          </NuxtLink>
